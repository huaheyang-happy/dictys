...
def pkg_setup():
	...
	setup(name=pkgname,
		...
		install_requires=['numpy','pandas','docutils','h5py','pyro-ppl','scipy','networkx','pybedtools','pyDNase','threadpoolctl','joblib','torch','matplotlib','adjustText','jupyter','docstring2argparse'],
		classifiers=[
